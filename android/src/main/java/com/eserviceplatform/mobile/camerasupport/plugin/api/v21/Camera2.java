package com.eserviceplatform.mobile.camerasupport.plugin.api.v21;
...
public class Camera2 extends CameraViewImpl {
    ...
    private MethodChannel.Result internalResult;
    ...
    private void collectCameraInfo() {
        ...
        for (android.util.Size size : map.getOutputSizes(mPreview.getOutputClass())) {
            ...
            if (width <= MAX_PREVIEW_WIDTH && height <= MAX_PREVIEW_HEIGHT && width >= MIN_PREVIEW_WIDTH && height >= MIN_PREVIEW_HEIGHT ) {
