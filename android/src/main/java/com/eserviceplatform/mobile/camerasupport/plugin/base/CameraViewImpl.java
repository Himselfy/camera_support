...
package com.eserviceplatform.mobile.camerasupport.plugin.base;
...
public abstract class CameraViewImpl {
    ...
    protected CameraViewImpl(Callback callback, PreviewImpl preview) {
        mCallback = callback;
        mPreview = preview;
    }
    ...
    public abstract void takePicture(MethodChannel.Result result);
